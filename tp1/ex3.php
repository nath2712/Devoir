...
?>
<a href = "/tp1/ex3.php?p=1&c=red&size=15px"> page 1</a>
<a href = "/tp1/ex3.php?p=2&c=green&size=30px"> page 2</a>
<a href = "/tp1/ex3.php?p=3&c=blue&size=50px"> page 3</a>
...
<form method="POST">
    ...
    <textearea type="message" value="" name="size" id="size">
